...
root -l -b -q 'RunTree_ReReco.C("TTJets", 30, true)'
...
root -l -b -q 'RunTree_ReReco.C("DYJetsToLL_M10to50_aMCatNLO", 5, true)'
...
#root -l -b -q 'RunTree_ReReco.C("TTbar_Powheg_Herwig"	, 5, true)'     #/TT_TuneEE5C_13TeV-powheg-herwigpp		       /RunIISpring15MiniAODv2-Asympt25ns_74X_mcRun2_asymptotic_v2-v1/MINIAODSIM        
#root -l -b -q 'RunTree_ReReco.C("TTbar_Powheg_ScaleDown", 5, true)'    #/TT_TuneCUETP8M1_13TeV-powheg-scaledown-pythia8       /RunIISpring15MiniAODv2-74X_mcRun2_asymptotic_v2-v1/MINIAODSIM  
#root -l -b -q 'RunTree_ReReco.C("TTbar_Powheg_ScaleUp"  , 5, true)'    #/TT_TuneCUETP8M1_13TeV-powheg-scaleup-pythia8	       /RunIISpring15MiniAODv2-74X_mcRun2_asymptotic_v2-v1/MINIAODSIM   
#root -l -b -q 'RunTree_ReReco.C("TTbar_Powheg_mtop1695" , 5, true)'    #/TT_TuneCUETP8M1_mtop1695_13TeV-powheg-pythia8        /RunIISpring15MiniAODv2-74X_mcRun2_asymptotic_v2-v1/MINIAODSIM   
#root -l -b -q 'RunTree_ReReco.C("TTbar_Powheg_mtop1755" , 5, true)'    #/TT_TuneCUETP8M1_mtop1755_13TeV-powheg-pythia8        /RunIISpring15MiniAODv2-74X_mcRun2_asymptotic_v2-v1/MINIAODSIM	
