...
void plotvar(TString var){
  ...
  httbar->Scale(1/httbar->Integral()); httbarMLM->Scale(1/httbarMLM->Integral()); hstop1->Scale(1/hstop1->Integral()); hstop2->Scale(1/hstop2->Integral());
  httbar->SetMarkerStyle(21); httbarMLM->SetMarkerStyle(21); hstop1->SetMarkerStyle(21); hstop2->SetMarkerStyle(21);
  httbar->SetMarkerSize(2.0); httbarMLM->SetMarkerSize(21); hstop1->SetMarkerSize(2.0); hstop2->SetMarkerSize(2.0);
  ...
  leg->AddEntry(hstop1, "stop_200_25", "l");
