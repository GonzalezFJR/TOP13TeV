...
TreeAnalysisTop::TreeAnalysisTop() : PAFChainItemSelector() {
	...
	for (unsigned int ichan = 0; ichan < gNCHANNELS; ichan++) {
		...
		for (unsigned int icut = 0; icut < iNCUTS; icut++) {
			...
			fHMET[ichan][icut] = 0;       
			fHDiLepPt[ichan][icut] = 0;   
			fHLep0Pt[ichan][icut] = 0;    
			fHLep1Pt[ichan][icut] = 0;    
			fHLep0Eta[ichan][icut] = 0;    
			fHLep1Eta[ichan][icut] = 0;    
			fHDelLepPhi[ichan][icut] = 0; 
			fHNJets[ichan][icut] = 0;     
			fHHT[ichan][icut] = 0;        
			fHHT2[ichan][icut] = 0;        
			fHHT3[ichan][icut] = 0;        
			fHHT4[ichan][icut] = 0;        
			fHHT5[ichan][icut] = 0;        
			fHNBtagJets[ichan][icut] = 0; 
			fHJet0Pt[ichan][icut] = 0;    
			fHJet1Pt[ichan][icut] = 0;    
...
void TreeAnalysisTop::InitialiseKinematicHistos(){
	...
	for (size_t ch=0; ch<gNCHANNELS; ch++){
		...
		for (size_t cut=0; cut<iNCUTS; cut++){
			...
			fHDiLepPt[ch][cut]     = CreateH1F("H_DiLepPt_"    +gChanLabel[ch]+"_"+sCut[cut],"DiLepPt"   , 1600,20,180); 
			...
			fHNJets[ch][cut]       = CreateH1F("H_NJets_"      +gChanLabel[ch]+"_"+sCut[cut],"NJets"     , 8 ,-0.5, 7.5);
			...
			fHJet1Pt[ch][cut]      = CreateH1F("H_Jet1Pt_"     +gChanLabel[ch]+"_"+sCut[cut],"Jet1Pt"    , 2200,30,250);
